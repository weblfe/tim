...
func TestIMServer_CreateGroup(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if (err != nil) != tt.wantErr {
				t.Errorf("CreateGroupApi() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			//if got != tt.want {
			//	t.Errorf("CreateGroupApi() got = %v, want %v", got, tt.want)
			//}
		})
	}
}
...
func TestIMServer_GetGroupInfo(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if (err != nil) != tt.wantErr {
				t.Errorf("GetGroupInfoApi() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("GetGroupInfoApi() got = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestIMServer_GetGroupMemberInfo(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if (err != nil) != tt.wantErr {
				t.Errorf("GetGroupMemberInfoApi() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("GetGroupMemberInfoApi() got = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if err := s.ModifyGroupBaseInfo(tt.args.m); (err != nil) != tt.wantErr {
				t.Errorf("ModifyGroupBaseInfoApi() error = %v, wantErr %v", err, tt.wantErr)
			}
		})
	}
}
...
func TestIMServer_AddGroupMember(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if (err != nil) != tt.wantErr {
				t.Errorf("AddGroupMemberApi() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("AddGroupMemberApi() got = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if err := s.DeleteGroupMember(tt.args.groupID, tt.args.reason, tt.args.silence, tt.args.memberToDelAccount); (err != nil) != tt.wantErr {
				t.Errorf("DeleteGroupMemberApi() error = %v, wantErr %v", err, tt.wantErr)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if err := s.DestroyGroup(tt.args.groupId); (err != nil) != tt.wantErr {
				t.Errorf("DestroyGroupApi() error = %v, wantErr %v", err, tt.wantErr)
			}
		})
	}
}
...
func TestIMServer_ImportGroup(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if (err != nil) != tt.wantErr {
				t.Errorf("ImportGroupApi() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if got != tt.want {
				t.Errorf("ImportGroupApi() got = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestIMServer_ImportGroupMsg(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if (err != nil) != tt.wantErr {
				t.Errorf("ImportGroupMsgApi() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("ImportGroupMsgApi() got = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestIMServer_ImportGroupMember(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if (err != nil) != tt.wantErr {
				t.Errorf("ImportGroupMemberApi() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("ImportGroupMemberApi() got = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if err := s.SetUnreadMsgNum(tt.args.group, tt.args.memberAccount, tt.args.unReadMsgNum); (err != nil) != tt.wantErr {
				t.Errorf("SetUnreadMsgNumApi() error = %v, wantErr %v", err, tt.wantErr)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := s.DeleteGroupMsgBySender(tt.args.groupId, tt.args.senderAccount); (err != nil) != tt.wantErr {
				t.Errorf("DeleteGroupMsgBySenderApi() error = %v, wantErr %v", err, tt.wantErr)
			}
		})
	}
}
...
func TestIMServer_GroupMsgGetSimple(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if (err != nil) != tt.wantErr {
				t.Errorf("GroupMsgGetSimpleApi() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("GroupMsgGetSimpleApi() got = %v, want %v", got, tt.want)
			}
		})
	}
}
